<template>
  <div id="tab-settings" v-loading="loading">
    <template v-if="currentStoreId">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="API secret" prop="api_secret">
          <el-input v-model="form.api_secret" :disabled="existing" type="password" style="width: 300px;"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button v-if="!existing" type="primary" round @click="handleSave">Save</el-button>
          <el-button v-else type="danger" round @click="handleDisconnect">DISCONNECT FROM DATACUE</el-button>
        </el-form-item>
      </el-form>
    ...
    <ul class="list" style="margin-left: 20px;">
      <li><a href="https://help.datacue.co/install/magento.html#add-recommendations" target="_blank" style="color: #8c5c85; font-weight: 600;">Add banners and products to your site</a></li>
    </ul>
    <el-divider></el-divider>
    <el-button type="success" style="margin-bottom: 20px;" round @click="loginToDataCue">LOGIN TO MY DATACUE DASHBOARD</el-button>
    <p>No account yet? Sign up <a href="https://app.datacue.co/en/sign-up" target="_blank" style="color: #8c5c85; font-weight: 600;">here</a></p>
    <el-divider></el-divider>
    <h4>Support Center</h4>
    <p>Questions? Need help? Email us at <a href="mailto:support@datacue.co" target="_blank" style="color: #8c5c85; font-weight: 600;">support@datacue.co</a> to speak to a real person</p>
  </div>
</template>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        api_secret: [
          { required: true, message: 'API secret is required', trigger: 'blur' },
        ],
      },
    };
  },
